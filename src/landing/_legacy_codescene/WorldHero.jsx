// Thumbtown hero overlay — top-left of viewport per spec §7.
// Eyebrow + H1 + subhead + primary CTA. Uses framer-motion fade presets
// from lib/motion.js. No scroll fade yet (no scroll content below in
// Phase 2) — just a mount-time fade-in.

import React from 'react';
import { motion } from 'framer-motion';
import { heroFade } from '../lib/motion';

export default function WorldHero({ onStartFree }) {
  return (
    <div
